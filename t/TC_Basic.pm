...
# $Id: TC_Basic.pm,v 1.3 2005/11/14 23:32:22 guido Exp $
...
sub testArray {
    ...
    my $count;
    my $wanted = sub {
	$self->assert_str_equals ('ARRAY', $Data::Traverse::type)
	    unless ref $_;
	++$count;
    };
    traverse $wanted, $data;
...
sub testHash {
    ...
    my $count;
    my $wanted = sub {
	$self->assert_str_equals ('HASH', $Data::Traverse::type)
	    unless ref $_;
	++$count;
    };
    traverse $wanted, $data;
