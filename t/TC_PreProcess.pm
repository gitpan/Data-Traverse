...
# $Id: TC_PreProcess.pm,v 1.2 2005/11/10 21:29:12 guido Exp $
...
sub testHash {
    ...
    traverse { wanted => $wanted, preprocess => $preprocess}, \%data;
...
sub testPreprocessHash {
    ...
    traverse { wanted => $wanted, preprocess_hash => $preprocess}, \%data;
